  ...
  }
  {
    ...
    replace (f x2 * g x2 - l * l') with (f x2 * (g x2 - l') + l' * (f x2 - l)).
    {
      ...
      }
      {
        ...
        cut ((1 + Rabs l) * (eps * mul_factor l l') + Rabs l' * (eps * mul_factor l l') <= eps).
        {
          ...
          }
          {
            ...
            apply Rplus_lt_le_compat.
            {
              ...
              }
              {
                ...
                rewrite (Rplus_assoc 1 (- Rabs l) (Rabs l)).
                rewrite (Rplus_opp_l (Rabs l)).
                rewrite (proj1 (Rplus_ne 1)).
        ...
        }
        {
          ...
          rewrite <- (Rmult_plus_distr_l (eps * mul_factor l l') (1 + Rabs l) (Rabs l')).
